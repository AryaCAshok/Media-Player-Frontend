...
function Add({setuploadVideoStausToAdd}) {
    ...
    //destructuring of utube link to get unique code
    const embededVideoLink = (e) => {
        const { value } = e.target;
        console.log(value.slice(-11));
        const videoLink = `https://www.youtube.com/embed/${value.slice(-11)}` //combine common url with unique id of each video
            ...
            >
                ...
                <Modal.Body>
                    ...
                    <Form className='border border-secondary p-3 rounded'>
                        ...
                        <Form.Group className="mb-3" controlId="formBasicEmail">
                            <Form.Control type="text" placeholder="Enter Video Utube Link" onChange={(e) => embededVideoLink(e)} />
                        </Form.Group>
                    </Form>
                </Modal.Body>
                <Modal.Footer>
